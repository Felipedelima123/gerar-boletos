...
__export(src_exports, {
  ...
  Boleto: () => Boleto,
  BoletoStringify: () => BoletoStringify,
  Bradesco: () => Bradesco,
  Caixa: () => Caixa,
  Cecred: () => Cecred,
  Datas: () => Datas,
  Endereco: () => Endereco,
  GeradorDeBoleto: () => GeradorDeBoleto,
  GeradorDeBoletoCarne: () => GeradorDeBoletoCarne,
  GeradorDeBoletoEntrada: () => GeradorDeBoletoEntrada,
  Itau: () => Itau,
  Pagador: () => Pagador,
  Santander: () => Santander,
  Sicoob: () => Sicoob,
  Sicredi: () => Sicredi,
  especiesDeDocumento: () => especiesDeDocumento,
  formatacoes: () => formatacoes_exports,
  validacoes: () => validacoes_exports
});
...
var GeradorDeBoletoEntrada = class {
  ...
  async gerarArquivo(dir = "./tmp/boletos", filename = "boleto", modelo) {
    ...
    const stream = import_fs.default.createWriteStream(`${dir}/${filename}.pdf`);
    this.processar();
